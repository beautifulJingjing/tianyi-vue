...
<div class="zt1">
  ...
  <div class="container">
    <div class="ban">
      <img src="../../../static/img/zt/zt6/ban.png" >
      <div class="input-con">
        <input class="fz16" type="tel" v-model="text" placeholder="请在此输入手机号码" maxlength="11">
      </div>
    </div>
    <div class="ban ban2">
      <img src="../../../static/img/zt/zt6/zhuanpan.png">
      <button @click="getRewardEv"></button>
    </div>
    <div class="prizeList">
      <div class="tit-container">
        <img class="prizeTit" src="../../../static/img/zt/zt6/box-tit.png" alt="">
        <span>活动奖品</span>
      </div>
      <ul>
        <li>
          <img src="../../../static/img/zt/icon-ej.jpg">
          <div>
            <p>魔声耳机</p>
            <span>1份</span>
          </div>
    ...
    <div class="ruleList">
      <div class="tit-container">
        <img class="ruleTit" src="../../../static/img/zt/zt6/box-tit.png" alt="">
        <span>活动规则</span>
      </div>
      <ul class="fz12">
        <li><span>1</span>活动时间：2017年06月01日-2017年06月30日；</li>
    ...
    <div class="lottery">
      <div class="tit-container">
        <img class="lotteryTit" src="../../../static/img/zt/zt6/box-tit.png" alt="">
        <span>获奖名单</span>
      </div>
...
export default {
  ...
  methods: {
    ...
    _confirmModal() {
      this.$router.push({path:'/m/pop/12',query:{spinfocode: this.$utils.query('id')}})
    }
  }
}
</script>
