...
<div class="zt1">
  ...
  <div class="container">
    <div class="ban">
      <img src="../../../static/img/zt/zt13/ban.png" >
      <input class="fz16" type="tel" v-model="text" placeholder="请在此输入手机号码" maxlength="11">
      <button @click="btnFlag && getRewardEv()"></button>
    </div>
  
    <div class="prizeList">
      <img class="prizeTit" src="../../../static/img/zt/zt13/prize_tit.png" alt="">
      <ul>
        <li>
          <img src="../../../static/img/zt/zt13/pptv.png" alt="">
          <p>PPTV会员一个月</p>
          <span> 10000份</span>
        </li>
        <li>
          <img src="../../../static/img/zt/zt13/icon_phone_yellow.png" alt="">
          <p> 100元电信话费  </p>
          <span>5份</span>
        </li>
        <li>
        ...
        <li>
          <img src="../../../static/img/zt/zt13/icon_phone_red.png" alt="">
          <p>1GB电信流量</p>
          <span>20份</span>
        </li>
        <li>
    ...
    <div class="ruleList">
      <img class="ruleTit" src="../../../static/img/zt/zt13/rule_tit.png">
      <ul class="fz12">
        <li><span>1</span>活动时间：2018年1月1日-2018年3月31日;</li>
    ...
    <div class="lottery">
      <img class="lotteryTit" src="../../../static/img/zt/zt13/md_tit.png" alt="">
...
export default {
  ...
  methods: {
    ...
    _confirmModal() {
      this.$router.push({path:'/m/pop/19',query:{spinfocode: this.$utils.query('id')}})
    }
  }
}
</script>
...
.container .ruleList ul li span{background:#c3232c !important}
.container .lottery ul li u{color:#c3232c !important}
.container .lottery .btnMore{color:#c3232c !important}
  .container{
