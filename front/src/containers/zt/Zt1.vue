...
<div class="zt1">
  ...
  <div class="container">
    <div class="ban">
      <img src="../../../static/img/zt/zt1/ban.jpg" >
      <div class="input-con">
    ...
    <div class="prizeList">
      ...
      <ul>
        <li>
          <img src="../../../static/img/zt/icon_five_hundred.png">
          <div>
            <p>500元话费</p>
            <span>2份</span>
          </div>
        ...
        <li>
          <img src="../../../static/img/zt/icon_hundred.png">
          <div>
            <p>100元话费</p>
            <span>10份</span> </div>
        </li>
        <li>
          <img src="../../../static/img/zt/icon_twenty.png">
          <div>
            <p>20元话费</p>
            <span>50份</span> </div>
        </li>
        <li>
          <img src="../../../static/img/zt/icon_five.png">
          <div>
            <p>5元话费</p>
            <span>5000份</span> </div>
        </li>
...
export default {
  ...
  methods: {
    ...
    _confirmModal() {
      this.$router.push({path:'/m/pop/2',query:{spinfocode: this.$utils.query('id')}})
    }
  }
}
</script>
    ...
    .ban{
      ...
      .input-con {
        ...
        button {
          ...
          background: linear-gradient(to bottom,#ff9e00,#ff8300);
          color: #fff;
          font-weight: 600;
        }
      }
