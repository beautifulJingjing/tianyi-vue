...
<div class="zt1">
  ...
  <div class="container">
    <div class="ban">
      <img src="../../../static/img/zt/zt5/ban.png" >
      <div class="input-con">
    ...
    <div class="main-inner">
      ...
      <div class="ruleList">
        ...
        <ul class="fz12">
          <li><span>1</span>活动时间：2017年03月01日-2017年05月31日；</li>
...
export default {
  ...
  methods: {
    ...
    _confirmModal() {
      this.$router.push({path:'/m/pop/10',query:{spinfocode: this.$utils.query('id')}})
    }
  }
}
</script>
...
@import '../../assets/css/variables';
  .container{
    background: url(../../../static/img/zt/zt5/bgs.png);
    .tit-container {
    ...
    .main-inner {
      background: url("../../../static/img/zt/zt5/bg-1.png") no-repeat;
