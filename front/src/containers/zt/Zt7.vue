...
<div class="zt1">
  ...
  <div class="container">
    <div class="ban">
      <img src="../../../static/img/zt/zt7/ban.png" >
      <div class="input-con">
        <input class="fz16" type="tel" v-model="text" placeholder="请在此输入手机号码" maxlength="11">
      </div>
    </div>
    <div class="ban ban2">
      <img src="../../../static/img/zt/zt7/zhuanpan.png">
      <button @click="getRewardEv"></button>
    </div>
    <div class="prizeList">
      <div class="tit-container">
        <img class="prizeTit" src="../../../static/img/zt/zt7/box-tit.png" alt="">
        <span>活动奖品</span>
      </div>
      <ul>
        <li class="clear">
          <img src="../../../static/img/zt/zt7/erji.png">
          <div>
            <p>魔声耳机</p>
            <span>1份</span>
          </div>
        ...
        <li class="clear">
          <img src="../../../static/img/zt/zt7/yellow.png">
          <div>
            <p>100元电信话费</p>
            <span>20份</span> </div>
        </li>
        <li class="clear">
          <img src="../../../static/img/zt/zt7/redphone.png">
          <div>
            <p>1G电信流量</p>
            <span>40份</span> </div>
        </li>
        ...
        <li class="clear">
          ...
          <div>
            <p>1元话费</p>
            <span>27000份</span> </div>
        </li>
      </ul>
    </div>
    <div class="ruleList">
      <div class="tit-container">
        <img class="ruleTit" src="../../../static/img/zt/zt7/box-tit.png" alt="">
        <span>活动规则</span>
      </div>
      <ul class="fz12">
        <li><span>1</span>活动时间：即日起-2017年08月31日；</li>
    ...
    <div class="lottery">
      <div class="tit-container">
        <img class="lotteryTit" src="../../../static/img/zt/zt7/box-tit.png" alt="">
        <span>获奖名单</span>
      </div>
...
export default {
  ...
  methods: {
    ...
    _confirmModal() {
      this.$router.push({path:'/m/pop/13',query:{spinfocode: this.$utils.query('id')}})
    }
  }
}
</script>
...
@import '../../assets/css/variables';
  .container{
    ...
    .ruleList {
      ...
      padding: px2rem(20) px2rem(40);
      ul {
        padding: px2rem(20) px2rem(20) px2rem(50);
        background: #ffffff;
        margin-top: px2rem(-5);
        position: relative;
        li{
