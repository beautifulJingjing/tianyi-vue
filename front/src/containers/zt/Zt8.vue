...
<div class="zt1">
  ...
  <div class="container">
    <div class="ban">
      <img src="../../../static/img/zt/zt8/ban.png" >
      <input class="fz16" type="tel" v-model="text" placeholder="请在此输入手机号码" maxlength="11">
    </div>
    <div class="ban ban2">
      <img src="../../../static/img/zt/zt8/zhuanpan.png">
      <button @click="getRewardEv"></button>
    </div>
    <div class="prizeList">
      <img class="prizeTit" src="../../../static/img/zt/zt8/tit.png" alt="">
      <ul>
        <li class="clear">
    ...
    <div class="ruleList">
      <img class="ruleTit" src="../../../static/img/zt/zt8/tit1.png">
      <ul class="fz12">
    ...
    <div class="lottery">
      <img class="lotteryTit" src="../../../static/img/zt/zt8/tit2.png" alt="">
...
export default {
  ...
  methods: {
    ...
    _confirmModal() {
      this.$router.push({path:'/m/pop/14',query:{spinfocode: this.$utils.query('id')}})
    }
  }
}
</script>
...
@import '../../assets/css/variables';
  .container{
    background: url("../../../static/img/zt/zt8/block.png");
    .ban{
      position: relative;
      font-size: 0;
      img{
