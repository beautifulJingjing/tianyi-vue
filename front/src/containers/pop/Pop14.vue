...
<div class="pop1">
  <div class="ban">
    <img src="../../../static/img/14/ban.png" alt="">
  </div>
  <div class="getBtn ban">
    <img src="../../../static/img/14/get-btn.png" alt="">
    <button @click="receiveBtn"></button>
    <p class="fz12">已有{{getReceiveNum}}人领取</p>
  </div>
  <div class="containerBox">
    <div class="notice">
      <div class="conTit">
        <img src="../../../static/img/14/tit.png">
        <p class="fz15">权益再升级&nbsp;福利添新喜</p>
      </div>
  ...
  <div class="ringList">
    <div class="ringTit">
      <img src="../../../static/img/14/layer-title.png" alt="">
    </div>
    <div class="allRing">
  ...
  <div class="floatLayer" :style="{opacity: styleOpacity,top: styleOpacity > 0.1 ? '0px' : ''}" @click="receiveBtn">
    <img src="../../../static/img/14/float-btn.png" alt="">
  </div>
</div>
</template>
...
.pop1 {
  background: url(../../../static/img/14/block.png);
