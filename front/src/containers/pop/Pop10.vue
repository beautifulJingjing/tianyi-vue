...
<div class="pop">
  <div class="ban">
    <img src="../../../static/img/10/ban.png" alt="">
    <p class="fz14">已有<span>{{getReceiveNum}}</span>人领取了福利</p>
    <img class="get-btn" src="../../../static/img/10/get-btn.png" @click="receiveBtn" alt="">
  </div>
  <div class="containerBox">
    <div class="container">
      <img src="../../../static/img/10/rule-tit.png" alt="">
      <div class="context fz13" id="con">
      </div>
      <img class="btm" src="../../../static/img/10/rule-bot.png" alt="">
    </div>
  </div>
  <div class="ringList">
    <div class="ring-tit fz15">
      2017超新超火爆铃声
    </div>
    <div class="ring-tit2"></div>
    <div class="allRing">
  ...
  <div class="floatLayer" :style="{opacity: styleOpacity,top: styleOpacity > 0.1 ? '0px' : ''}" @click="receiveBtn">
    <img src="../../../static/img/10/get-btn.png" alt="">
  </div>
</div>
</template>
...
.pop {
  background: url("../../../static/img/10/bgs.png");
  ...
  .containerBox {
    background: url(../../../static/img/10/bg-1.png) no-repeat;
    ...
    .container {
      ...
      .context {
        background: url("../../../static/img/10/rule-bg.png") repeat-y;
        background-size: 100% auto;
  ...
  .ringList {
    ...
    position: relative;
    background: url(../../../static/img/10/bg-2.png) no-repeat;
    background-size: 100% auto;
    .ring-tit {
      width: 90%;
      height: px2rem(60);
