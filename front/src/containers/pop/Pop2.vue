...
<div class="pop">
  <div class="ban">
    <img src="../../../static/img/2/ban.jpg" alt="">
  </div>
  <div class="getBtn ban">
    <div class="btn fz20" @click="receiveBtn">
      点击领取
      <img src="../../../static/img/2/btn-arrow.png" alt="">
    </div>
    <img class="get_msg" src="../../../static/img/2/red-sm.png" alt="">
  </div>
  <div class="containerBox">
    <div class="title">
      <img src="../../../static/img/2/icon-heart.png" alt="">
