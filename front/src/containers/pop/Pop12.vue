...
<div class="pop">
  <div class="ban">
    <img src="../../../static/img/12/ban.png" alt="">
    <p class="fz14">
      <img src="../../../static/img/12/icon-num.png" alt="">
      已有<span>{{getReceiveNum}}</span>人领取到福利</p>
    <img class="img_btn" @click="receiveBtn" src="../../../static/img/12/get-btn.png" alt="">
  </div>
  <div class="containerBox">
    <p class="tit fz15">活动说明</p>
    <div class="context fz13" id="con">
    </div>
  </div>
  <div class="ringList">
    <div class="ringTit fz15">
      2017年5月下载破千万铃声
    </div>
    <div class="allRing">
      <Rings :lists="ringList" :data="{vip: '3'}" :styles="{
        imgPlay: '../../static/img/12/btn-play.png',
        imgPause: '../../static/img/12/btn-pause.png',
        imgSetRing : '../../static/img/12/btn-setring.png',
        imgDownRimg : '../../static/img/12/btn-download.png',
  ...
  <div class="floatLayer" :style="{opacity: styleOpacity,top: styleOpacity > 0.1 ? '0px' : ''}" @click="receiveBtn">
    <img src="../../../static/img/12/get-btn-top.png" alt="">
  </div>
</div>
</template>
