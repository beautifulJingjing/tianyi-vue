...
var unicom = {
    regexPhone: new RegExp(/^((13[0-2])|145|(15[5|6])|176|(18[5|6]))\d{8}$/)
};
var telecom = {
...
var app = (function() {
    ...
    var user = {
        ...
        logined: function() {
            ...
            else if (!unicom.regexPhone.test(this.phone) && !telecom.regexPhone.test(this.phone)) return this.isorder();
            else return true
        },
        get hidephone() {
    ...
    var doPlay = function(e) {
        ...
        mplayer.doPlay('http://tianyiring.com/proxy/v3/audition.aspx?rid={0}'.format(sender.data('rid')), sender)
    };
                ...
                if (r.s == 1) {
                    ...
                    if (r.s == -10) {
                        ...
                        if (pushinfo.order.pop.type == 2) mbox.explain({
                            ...
                            if (pushinfo.order.mode == 903 && pushinfo.login.mode == 2) alertOpenOrder(opt);
    ...
    var doLoginOpen = function(e, option) {
        if (pushinfo.order.mode == 1) option.cmd = 'login-order';
