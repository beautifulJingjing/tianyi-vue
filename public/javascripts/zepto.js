...
; (function ($) {
  ...
  if (String.prototype.format === undefined) //�ַ�����ʽ��
  ...
  if (String.prototype.toHtml === undefined)
  ...
  if(String.prototype.startsWith === undefined)
	String.prototype.startsWith = function(start) {
	  ...
	  else if(start == null || start.length > this.length || !this) return false;
  ...
  if(String.prototype.endsWith === undefined)
	String.prototype.endsWith = function(end) {
	  if(end == '') return true;
	  else if(end == null || end.length > this.length || !this) return false;
  ...
  $.getScript = function (src, callback) {
    if ($('script[src="' + src + '"]').length > 0) callback.call()
    else {
  ...
  //����cookieֵ
  //����(cookie��,cookieֵ,��Чʱ��:����,��Ч��)
  $.setCookie = function (name, value, expiresminutes, domain) {
    var exdate = new Date()
    exdate.setTime(exdate.getTime() + (expiresminutes * 1000))
    document.cookie = name + "=" + escape(value) +
      ((expiresminutes == null) ? "" : ";expires=" + exdate.toGMTString()) +
  ...
  //����url��ַ��hashֵ, ��ʽname1=value1;name2=value2;����
  //����(hash������,��Ӧֵ)
